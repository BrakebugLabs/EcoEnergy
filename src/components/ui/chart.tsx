...
// 🟢 DEFINIÇÃO DOS TIPOS DO PAYLOAD PARA ELIMINAR ERROS EM CADEIA
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithRef<"div"> & {
    active?: boolean;
    payload?: TooltipPayloadItem[]; // 🟢 CORRIGIDO: Tipagem explícita para o array do Tooltip
    hideLabel?: boolean;
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentPropsWithRef<"div"> & {
    hideIcon?: boolean;
    nameKey?: string;
    payload?: LegendPayloadItem[]; // 🟢 CORRIGIDO: Tipagem explícita para o array de Legenda do Recharts
